...
public class Argument
{
    ...
    {
        if(((this.getStartOffset() > other.getStartOffset()) && (this.getEndOffset() <= other.getEndOffset())) ||
    ...
    public boolean equals(Object other)
    {
        ...
        if((this.startOffset == o.startOffset) && (this.endOffset == o.endOffset) && (this.argName.equals(o.argName)))
        {
            return true;
        }
        else
