...
public class RunMultiModelDistantSupervision {
	...
	InstantiationException{
		...
		KnowledgeBase kb = new KnowledgeBase(arguments.get(0),arguments.get(1),arguments.get(2));
		Boolean newNegativeExampleCollection = Boolean.parseBoolean(arguments.get(3));
